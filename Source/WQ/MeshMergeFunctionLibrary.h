...
struct WQ_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT( BlueprintType )
struct WQ_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT( BlueprintType )
struct WQ_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
...
*/
USTRUCT( BlueprintType )
struct WQ_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class WQ_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
